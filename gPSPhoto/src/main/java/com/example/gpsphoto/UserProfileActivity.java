...
///
///This class is same with ProfileActivity.
// UserProfileActivity is the class that show any users.
// ProfileActivity is the class that show my information.
public class UserProfileActivity extends Activity {
	 ...
	 String mCurrentPhotoPath;
		...
		public class MessageHandler extends Handler {
	        ...
	        public void MessageBox(String str){
	    		new AlertDialog.Builder(UserProfileActivity.this).setTitle("Message")
	        ...
	        public void handleMessage(Message msg) {
	        	...
	        	case Global.CONNECTION_OK:
	        		...
	        		try {
				        ...
				        if( resArray.size() > 0 ){
				        	ProfileImageListAdapter objAdapter = new ProfileImageListAdapter(UserProfileActivity.this, R.layout.profile_image_item,
				        			resArray);
		...
		Handler signupHandler = new MessageHandler2();
		public class MessageHandler2 extends Handler {
	        ...
	        public void handleMessage(Message msg) {
	        	...
	        	case Global.UPLOADPICTURE_OK:
	        		UpdateUserInfo(Global.SERVER + "uploads/logo/" + photoUpload.getFileName());
	        		break;
	        	...
	        	case Global.CONNECTION_OK:
	        		...
	        		if( res.equals("true") ){
	        			new AlertDialog.Builder(UserProfileActivity.this).setTitle("Notification")
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		connection = new Connection(UserProfileActivity.this, Global.SERVER + Global.LOGIN_URL, params, serverhandler);
		connection.execute();
	...
	public void UpdateUserInfo(String path){
        ...
        params.add(new BasicNameValuePair("id", String.valueOf(Global.temp_user_id)));
		...
		connection = new Connection(UserProfileActivity.this, Global.SERVER + Global.LOGIN_URL, params, signupHandler);
		connection.execute();
	}
	public void OnClickChangeInfo(View view){
		...
		if( imgFilePath != null )	
		{
			photoUpload = new PhotoUpload(UserProfileActivity.this, Global.SERVER + Global.UPLOADLOGO_URL, imgFilePath, signupHandler);
			photoUpload.execute(imgFilePath);
		}else
		{
			UpdateUserInfo(photoAddress);
		}
	}
	public void ShowUserInfo(String username, String picture){
		...
		if(!imageLoder.isInited())
			imageLoder.init(ImageLoaderConfiguration.createDefault(UserProfileActivity.this));
		...
		photoAddress = picture;
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("type", "userid"));
        params.add(new BasicNameValuePair("userid", String.valueOf(Global.temp_user_id)));
        connection = new Connection(UserProfileActivity.this, Global.SERVER + Global.GETPHOTO_URL, params, photoHandler);
		connection.execute();
	     ...
	     if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data){
	    	 ...
	    	 if( requestCode == REQUEST_CAMERA && resultCode== Activity.RESULT_OK){
	             ...
	             if (photoFile!=null && photoFile.exists()) {
	                 ...
	                 imgFilePath = getRealPathFromURI(UserProfileActivity.this, mUriPhoto);
