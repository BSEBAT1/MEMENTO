    ...
    public void onFilteredLocationChanged(Context context, Location location)
    {
        ...
        if (location != null)
        {
            ...
            else
            {
            	...
            	/*Toast.makeText(context, "location added	lat : " +String.valueOf(location.getLatitude()) + "lon : "+
            			String.valueOf(location.getLongitude() + " accuracy = " + location.getAccuracy()) , Toast.LENGTH_LONG).show();*/
            }
        }
    }
}
