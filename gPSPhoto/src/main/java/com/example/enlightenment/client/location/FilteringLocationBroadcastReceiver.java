...
public abstract class FilteringLocationBroadcastReceiver extends LocationBroadcastReceiver
{
    ...
    private static final int MY_ACCURACY = 15; // m/s
    private static final int MY_BETWEENTIME = 30000; // m/s
    @Override
    public void onLocationChanged(Context context, Location location)
    {
        ...
        else
        {
            ...
            {
                Log.d(TAG, "Adding point");
                if(currentAccuracy < MY_ACCURACY && (location.getTime() - lastPoint.getTime()) > MY_BETWEENTIME )
                	onFilteredLocationChanged(context, location);
            }
            else
            {
